...
public function store(){
    ...
    if(!$info) {// 上传错误提示错误信息
        ...
        $data['programintro']=$_POST['programintro'];
        $data['programcroud']=$_POST['programcroud'];
        ...
        //设置thumb字段属性(目录+名字)
        $data['programpicture']=$info['programpicture']['savepath'].$info['programpicture']['savename'];
        $data['programxcpic']=$info['programxcpic']['savepath'].$info['programxcpic']['savename'];

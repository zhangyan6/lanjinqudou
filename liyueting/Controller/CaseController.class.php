...
public function store(){
    ...
    if(!$info) {// 上传错误提示错误信息
        ...
        $data['cintro1']=$_POST['cintro1'];
        $data['cintro2']=$_POST['cintro2'];
       
        // $data['cpicture']=$_POST['cpicture'];
        
 
        //设置thumb字段属性(目录+名字)
        $data['cpicture1']=$info['cpicture1']['savepath'].$info['cpicture1']['savename'];
        $data['cpicture2']=$info['cpicture2']['savepath'].$info['cpicture2']['savename'];
